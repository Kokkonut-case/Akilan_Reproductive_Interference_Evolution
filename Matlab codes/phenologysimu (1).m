function [data,warning]=phenologysimu(popsize,d,v,C,L,mut,mutsize,initmean,shared,generations)
% simulation approach
...
for k=1:generations
    ...
    for i=1:length(f)
        ...
        T_encounter(1:trackmatings,f(i))=sorted(1:trackmatings); who_encounter(1:trackmatings,f(i))=whichmale(1:20);
    end
